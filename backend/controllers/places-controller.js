...
const getPlacesByUserId = async (req, res, next) => {
  ...
  try {
    ...
    return next(new HttpError("Something goes wrong, try again", 500));
  }
...
const createPlace = async (req, res, next) => {
  ...
  const location = { lat: 40.7484474, lng: -73.9871516 };
...
const deletePlace = async (req, res, next) => {
  ...
  try {
    ...
    return next(new HttpError("Cannot delete that place", 500));
  }
  ...
  try {
    ...
    place.creator.places.pull(place); // REMOVES ID FROM USER.PLACES
